    ...
    return (
      <div className={styles.diceWrapper}>
        <div className={[styles.dice]}>
          ...
          <div className={[styles.side, styles.top, styles.inner].join(" ")} />
          ...
          <div className={[styles.side, styles.left, styles.inner].join(" ")} />
          ...
          <div className={[styles.side, styles.back, styles.inner].join(" ")} />
          <div className={[styles.side, styles.cover, styles.x].join(" ")} />
          <div className={[styles.side, styles.cover, styles.y].join(" ")} />
          <div className={[styles.side, styles.cover, styles.z].join(" ")} />
        </div>
      </div>
    );
  };
